...
func LoadSchoolData() error {
	...
	insertSQL := `INSERT INTO nz_school_academics (school_id, year, year_level_id, category_id, performance_id, current_achievement_rate, cumulative_achievement_rate) VALUES `
